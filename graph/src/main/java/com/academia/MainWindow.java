...
public class MainWindow extends JFrame {
    ...
    private void run() {
        ...
        bPanel.openBtn.addActionListener(listener -> {
            File path = new File("C:\\Users\\Gorazd Murko\\Desktop\\PROGRAMIRANJE\\JAVA\\VAJE\\1_Vaja");
        ...
        menuBar.itemOpen.addActionListener(listener -> {
            ...
            JFileChooser fileChooser = new JFileChooser("C:\\Users\\Gorazd Murko\\Desktop\\PROGRAMIRANJE\\JAVA\\VAJE");  // type in the path
